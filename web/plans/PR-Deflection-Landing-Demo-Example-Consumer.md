...
ATLAS #1858 then enriched that producer input to 360 real synthetic rows, so
the same generated pair is now marketing-scale without reintroducing hand-made
portfolio fixtures.
...
- The ATLAS generated example is moderately large: 360 synthetic ticket rows,
  with the top repeat at 100 tickets. This is the accepted middle ground from
  #1858: coherent producer evidence without the original 1,140-row fixture
  bloat.
