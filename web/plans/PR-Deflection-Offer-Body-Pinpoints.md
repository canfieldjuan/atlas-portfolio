...
2. Replace the current six deliverable bullets with a tighter four-item "for each question" list: customer wording, documentation gap, source tickets, and FAQ draft.
...
The FAQ draft bullet keeps the operator's "ready-to-review" framing. This preserves the human-review boundary and avoids implying automatic publishing.
