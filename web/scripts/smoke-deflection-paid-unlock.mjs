...
const REQUIRED_PAID_MARKERS = [
  { key: 'paidReportBadge', labels: ['FULL BACKLOG REPORT', 'FULL RESOLUTION AUDIT', 'FULL DEFLECTION REPORT'] },
  {
    key: 'paidHeadline',
    labels: [
  ...
  { key: 'reportContents', labels: ['Paid report contents', 'Full audit dashboard', 'Full report dashboard'] },
