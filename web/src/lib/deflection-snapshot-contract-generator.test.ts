...
} from '../../scripts/generate-deflection-snapshot-contract.mjs';
...
describe('deflection snapshot contract generator', () => {
it('renders and checks generated contracts with the real generator', async () => {
