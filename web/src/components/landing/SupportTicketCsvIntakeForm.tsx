...
import { deflectionResultsPath } from '@/lib/gap-report-intake';
...
export function SupportTicketCsvIntakeForm({ copy }: { copy: SupportTicketCsvIntakeCopy }) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const metadata = {
      ...
      supportPlatform: 'other', // Default to other to shrink form and satisfy backend contract
    ...
    <div className="rounded-2xl border border-border bg-surface p-6 md:p-8 shadow-sm">
      <div className="mb-8">
        ...
        <p className="text-foreground/65 text-sm leading-relaxed">
          Upload 30 days of closed tickets. The Snapshot ranks repeated questions, identifies blind spots, and prepares review-ready drafted answers using repeatable clustering.
        </p>
      </div>
        ...
        <div className="rounded-lg border border-primary/35 bg-primary/[0.08] p-4 mt-6 space-y-3">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] leading-relaxed text-foreground/75">
                Uploaded directly to private storage. Files are automatically deleted after 30 days. No LLM training or data retention.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-2 border-t border-primary/20 pt-3">
            ...
            <div>
              ...
              <p className="text-[11px] leading-relaxed text-foreground/75">
                Emails, phone numbers, and IP addresses are scrubbed client-side via regex before upload.
              </p>
            </div>
          </div>
        </div>
