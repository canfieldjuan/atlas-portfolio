...
export default function AuditForm({ initialInterest, initialContext }: AuditFormProps) {
  ...
  // Validated server-side and passed as props; held as plain consts so the initial render
  // (server and client) is identical and there is no flash-of-wrong-content.
