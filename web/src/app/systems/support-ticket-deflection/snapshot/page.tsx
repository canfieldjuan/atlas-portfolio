...
export const metadata = generatePageMetadata({
  ...
  description:
    'Upload 30 days of closed tickets and get a free Deflection Snapshot: ranked repeat questions, customer wording, relative priority scores, and one sourced drafted answer preview.',
