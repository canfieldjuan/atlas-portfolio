...
const baseMetadata = generatePageMetadata({
  ...
  description:
    'Design-partner access to the Support Ticket Deflection Report. Upload 30 days of closed support tickets; we send back a free Deflection Snapshot in seconds, and the full report is $1,000 for the first 5 design partners.',
