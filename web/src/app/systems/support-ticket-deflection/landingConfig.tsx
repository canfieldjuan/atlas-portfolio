...
const useCases = [
  ...
  },
  {
    ...
    detail:
      `Your KPI is not “write more FAQs.” It is fewer avoidable tickets. The problem is that the inbox is too busy to stop and sort 3 months of tickets by hand.`,
  },
  {
...
export const landingPageConfig: DiagnosticReportLandingPageConfig = {
  ...
  hero: {
    ...
    title:
      'Turn 3 months of messy support tickets into a clean help-center fix list.',
    intro:
  ...
  solution: {
    ...
    content: (
      <div className="space-y-4 text-foreground/65 leading-relaxed">
        <p>
          Those answers are buried across months of tickets, too much to read by hand. Upload 3 months of closed tickets and we pull the pattern out: the repeat questions ranked by volume, the exact words customers use when they’re stuck (not your internal labels), and a drafted answer for each.
        </p>
        <p>
  ...
  audience: {
    ...
    description:
      'This fits best at a 15–75-person B2B SaaS team: big enough that the same questions repeat across months of tickets, small enough that every avoidable ticket still costs real agent time. If you can export 3 months of tickets and already run a help center, you have what the report needs.',
    items: useCases,
  ...
  pricing: {
    ...
    description:
      'The free snapshot gives you enough to see whether your old tickets are hiding deflectable support work. If the pattern is there, the full Deflection Report turns that first 3 month batch into answers your team can actually review and publish.',
    tiers: pricingTiers,
  ...
  finalCta: {
    ...
    body: [
      'Upload 3 months of closed tickets. Your free Deflection Snapshot comes back within 24 hours, no integration required.',
