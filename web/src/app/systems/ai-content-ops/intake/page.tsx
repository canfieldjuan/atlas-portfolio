        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="rounded-2xl border border-primary/30 bg-primary/[0.04] p-8 md:p-12 shadow-[0_0_40px_rgba(0,255,204,0.04)]">
            ...
            <p className="text-foreground/70 leading-relaxed mb-3">
              We have your file. The Gap Report will be in your inbox within 48 hours.
              You will hear from us at <span className="text-white">{email}</span>.
            </p>
            <p className="text-foreground/65 leading-relaxed mb-6">
              If something looks off — wrong company name, wrong file, wrong email — reply to
              the confirmation message and we will sort it before the report goes out.
            </p>
    ...
    <main className="min-h-screen pt-20 pb-20 px-6 relative z-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-white mb-4">
            One file. Three fields. 48 hours.
          </h1>
          <p className="text-foreground/65 leading-relaxed">
            Upload a CSV export of the last 90 days of your closed support tickets. We
            send back the full Gap Report — ranked questions, gap callouts, deflection
            math, and 3 publish-ready FAQ drafts. Free for the first 5 design partners.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-6">
          ...
          <div>
            ...
            >
              Support platform <span className="text-foreground/45">(optional)</span>
            </label>
            <select
              id="supportPlatform"
              value={supportPlatform}
              onChange={(e) => setSupportPlatform(e.target.value as SupportPlatform | '')}
              disabled={submitting}
            ...
            <p className="mt-2 text-xs text-foreground/50">
              Helps us interpret your column layout faster. Skip if you are unsure or are exporting
          ...
          <div>
            ...
            <p id="csv-hint" className="mt-2 text-xs text-foreground/50 leading-relaxed">
              Subject lines and ticket bodies. ~2,000+ closed tickets recommended for the
              first run. Max 4 MB. Don&apos;t include PII if your export tool can strip it; if
              not, send the CSV anyway and we drop PII in our intake step before any model
              sees it.
            </p>
          </div>
